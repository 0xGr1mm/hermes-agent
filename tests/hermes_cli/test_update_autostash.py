...
def _patch_gateway_discovery(monkeypatch, isolated_source_completion):
    ...
    monkeypatch.setattr("hermes_cli.update_cmd_maint._run_post_update_maintenance", lambda *a, **k: True)
